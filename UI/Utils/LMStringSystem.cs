...
namespace LinkedMovement.UI.Utils {
    public enum LMStringKey {
        ...
        LINK_NAME,
        SAVED_ANIMATION_ALREADY_EXISTS,
    }
    ...
    public class LMStringSystem {
        private static readonly Dictionary<LMStringKey, string> texts = new() {
            ...
            { LMStringKey.ANIM_STEP_ROTATION, "The degrees, relative to the starting rotation, the object should rotate.\n\nA full rotation around an axis is '360'.\nPositive an negative values are permitted." },
            { LMStringKey.ANIM_STEP_SCALE, "The scale, relative to the starting scale, to resize the object.\n\nNegative values will shrink the object.\nPositive values will expand the object." },
            { LMStringKey.ANIM_STEP_COLOR, "Set these to animate the object's custom colors." },
            { LMStringKey.ANIM_STEP_END_DELAY, "The amount of time (in seconds) the animation should wait after completing this step." },
            ...
            { LMStringKey.SAVED_ANIMATION_ALREADY_EXISTS, "Saved Animation Steps with name '{0}' already exists. Overwriting." },
        };
